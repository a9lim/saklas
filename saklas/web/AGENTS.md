...
webui/src/
  ...
  panels/
    ...
    ProbeRack.svelte          # fused vector + manifold probe strips, sorted within each family, with "+ add probe" / "+ add manifold probe" footer (mirrors SteeringRack's vector + manifold layout)
