...
Six top-level verbs (no ``pack`` verb, no ``vector`` alias — pack
distribution folded into the manifold artifact):

    saklas tui <model> [...]
    saklas serve <model> [...]
    saklas subspace {extract,merge,compare,why,transfer} ...
    saklas manifold {fit,discover,generate,ls,show,install,...} ...
